...
public class SwingUserInterface implements MinecraftUserInterface {
	...
	private volatile Runnable modpackCancelAction;

	private volatile boolean modpackInstalling;
	...
	public void setModpackProgress(
	...
	public void hideModpackProgress() {
	...
	public void beginModpackInstallation(
			Runnable cancelAction
	) {

		this.modpackCancelAction = cancelAction;
		this.modpackInstalling = true;
		...
		SwingUtilities.invokeLater(() -> {
			...
			launcherPanel
					.getBottomBar()
					.getPlayButtonPanel()
					.setModpackInstalling(
							true,
							this::cancelModpackInstallation
					);
		});
	}

	public void finishModpackInstallation() {

		this.modpackInstalling = false;
		this.modpackCancelAction = null;
	...
	private void cancelModpackInstallation() {

		Runnable action =
				this.modpackCancelAction;

		if (
				this.modpackInstalling
						&& action != null
		) {
