...
public class PlayButtonPanel extends JPanel implements RefreshedVersionsListener, RefreshedProfilesListener, UserChangedListener {
	...
	private boolean modpackInstalling = false;

	private Runnable modpackCancelAction;
	...
	public PlayButtonPanel(Launcher minecraftLauncher) {
		...
		this.playButton.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				if (modpackInstalling) {

					if (modpackCancelAction != null) {
						modpackCancelAction.run();
					}
	...
	public void setModpackInstalling(
			boolean installing,
			Runnable cancelAction
	) {

		this.modpackInstalling = installing;
