...
import net.minecraft.launcher.ui.popups.modpack.InstallModpackPopup;
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (e.getSource() == this.newProfileButton) {
			...
			if (choice == 0) {
				...
				this.minecraftLauncher
						.getProfileManager()
						.setSelectedProfile(profile.getName());

			} else if (choice == 1) {

				InstallModpackPopup.showInstallModpackDialog(
						getMinecraftLauncher()
				);
			}
